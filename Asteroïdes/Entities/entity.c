...
t_entity*EntityDraw(const t_entity*pEntity, SDL_Renderer*pRenderer){
	...
	SDL_RenderDrawLines(pRenderer, pEntity->m_pVertices, pEntity->m_szVertices);
	SDL_RenderDrawPoints(pRenderer, pEntity->m_pVertices, pEntity->m_szVertices);
